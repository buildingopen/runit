    ...
    <>
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-12 bg-[var(--bg-secondary)] border-b border-[var(--border-subtle)] flex items-center justify-between px-4 z-40">
        ...
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-[var(--text-primary)] text-[13px]">RunIt</span>
        </Link>
      ...
      >
        ...
        <div className="h-12 px-4 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-[var(--text-primary)] text-[13px] tracking-tight">RunIt</span>
          </Link>

...
export default function MarketingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-[1100px] mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/signup" className="px-5 py-2 text-[13px] font-medium bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-lg transition-colors">Go live for free</Link>
          </div>
        </div>
      </nav>
        ...
        <div className="relative max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            ...
            <div className="flex flex-col items-center gap-6">
              <Link href="/signup" className="px-10 py-4 text-[16px] font-semibold bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-xl transition-all hover:shadow-[0_0_32px_rgba(16,185,129,0.3)] hover:-translate-y-0.5">
                Go live for free
              </Link>
          ...
          <div className="max-w-[680px] mx-auto">
            <div className="rounded-xl border border-white/[0.08] bg-[#0c0c0e] overflow-hidden shadow-2xl shadow-black/40">
              ...
              <div className="p-5 font-mono text-[13px] leading-[1.8]">
                <div className="term-line term-line-1 text-[var(--text-tertiary)]">
                  <span className="text-[var(--accent)]">$</span> Uploading invoice_generator.zip...{' '}
                  <span className="text-[var(--text-secondary)]">done</span>
                </div>
                <div className="term-line term-line-2 text-[var(--text-tertiary)] mt-1">
                  <span className="text-[var(--accent)]">$</span> Installing dependencies...{' '}
                  <span className="text-[var(--text-secondary)]">done</span>
                </div>
                <div className="term-line term-line-3 text-[var(--text-tertiary)]">
                  <span className="text-[var(--accent)]">$</span> Scanning for actions...{' '}
                  <span className="text-[var(--accent)]">3 found</span>
                </div>
                <div className="term-line term-line-4 text-[var(--text-tertiary)]">
                  <span className="text-[var(--accent)]">$</span> Going live...{' '}
                  <span className="text-[var(--accent)]">ready</span>
                </div>
                <div className="term-line term-line-5 mt-3 pt-3 border-t border-white/[0.06]">
                  <span className="text-[var(--text-tertiary)]">Your app is live at</span>
                  <br />
      ...
      <section className="fade-in-section py-24 px-6 bg-white/[0.015] border-t border-[var(--border-subtle)]">
      ...
      <section className="fade-in-section py-24 px-6 border-t border-[var(--border-subtle)]">
          ...
          <div className="hidden md:grid md:grid-cols-3 gap-0">
            <div className="relative p-6">
              <StepCard
                ...
                description="Paste a Python script or drop a .zip file. We handle the rest."
              ...
              />
              <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-10 w-8 h-8 rounded-full bg-[var(--bg-primary)] border border-white/[0.08] flex items-center justify-center">
            ...
            <div className="relative p-6">
              <StepCard
                ...
                description="Your code gets a live URL and an auto-generated interface. No frontend needed."
                icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.385 3.17M6.09 6.09l5.33 3.168m0 0l5.33-3.168M11.42 9.26v6.91m5.385 3.17L21.75 16.5V7.5l-4.945-2.83M6.09 6.09L1.145 3.26v9l4.945 2.83" /></svg>}
              />
              <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-10 w-8 h-8 rounded-full bg-[var(--bg-primary)] border border-white/[0.08] flex items-center justify-center">
                <svg className="w-4 h-4 text-[var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </div>
            ...
            <div className="p-6">
              <StepCard
                ...
                description="Anyone can run your app from their browser. Share it with your team, clients, or the world."
      ...
      {/* ============ SECTION 4: Social Proof + Audience ============ */}
      <section className="fade-in-section py-24 px-6 bg-white/[0.015] border-t border-[var(--border-subtle)]">
        <div className="max-w-[900px] mx-auto">
          {/* Audience */}
          <div className="text-center mb-14">
            <h2 className="text-[32px] font-bold text-[var(--text-primary)] mb-3">Built for people who create with AI</h2>
          ...
          <div className="text-center mb-10">
            <h3 className="text-[20px] font-semibold text-[var(--text-primary)] mb-2">What early users are saying</h3>
          </div>
      ...
      {/* ============ SECTION 5: Final CTA ============ */}
      <section className="fade-in-section relative py-28 px-6 overflow-hidden border-t border-[var(--border-subtle)]">
        ...
        <div className="relative max-w-[600px] mx-auto text-center">
          ...
          <Link href="/signup" className="inline-flex px-10 py-4 text-[16px] font-semibold bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-xl transition-all hover:shadow-[0_0_32px_rgba(16,185,129,0.3)] hover:-translate-y-0.5">
            Go live for free
          </Link>
          ...
          <p className="mt-6 text-[13px] text-[var(--text-tertiary)]">Join 200+ builders on the waitlist</p>
        </div>
      </section>
      ...
      <div className={`sticky-mobile-cta ${stickyVisible ? 'visible' : ''}`}>
        <Link
          href="/signup"
          className="block w-full py-3 text-[14px] font-semibold bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-lg text-center transition-colors"
        >
          Go live for free
        </Link>
      </div>
...
function WaitlistForm({ source }: { source: string }) {
  ...
  if (status === 'success') {
    return (
      <div className="flex items-center justify-center gap-2 text-[14px] text-[var(--accent)] font-medium">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-2 max-w-[420px] mx-auto">
      <input
        type="email"
        ...
        required
        className="w-full sm:flex-1 px-4 py-2.5 text-[14px] bg-white/[0.04] border border-white/[0.08] rounded-lg text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:border-[var(--accent)]/40 focus:bg-white/[0.06] outline-none"
      />
      <button
        type="submit"
        disabled={status === 'loading'}
        className="w-full sm:w-auto px-5 py-2.5 text-[13px] font-semibold bg-white/[0.04] border border-white/[0.08] text-[var(--text-primary)] rounded-lg hover:bg-white/[0.07] hover:border-white/[0.12] transition-all disabled:opacity-50 whitespace-nowrap"
      >
        {status === 'loading' ? 'Joining...' : 'Get early access'}
      </button>
      {status === 'error' && (
        <p className="text-[12px] text-[var(--error)] w-full text-center sm:text-left">{errorMsg}</p>
      )}
    </form>
  );
}
...
function StepCard({ number, title, description, icon }: { number: string; title: string; description: string; icon: React.ReactNode }) {
  return (
    <div className="group relative p-6 bg-[var(--bg-secondary)] border border-white/[0.06] rounded-xl hover:border-white/[0.1] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 transition-all">
      <div className="flex items-center gap-3 mb-5">
        <div className="w-9 h-9 bg-[var(--accent)] rounded-lg flex items-center justify-center shadow-[0_0_16px_rgba(16,185,129,0.25)]">
          <span className="text-[14px] font-bold text-white">{number}</span>
        </div>
...
function AudienceCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="p-6 rounded-xl bg-[var(--bg-secondary)] border border-white/[0.06] hover:border-white/[0.1] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 transition-all">
...
function TestimonialCard({ quote, name, role }: { quote: string; name: string; role: string }) {
  return (
    <div className="p-6 rounded-xl bg-[var(--bg-secondary)] border border-white/[0.06] hover:border-white/[0.1] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 transition-all">
      <svg className="w-6 h-6 text-[var(--accent)]/40 mb-4" fill="currentColor" viewBox="0 0 24 24">
        <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H14.017zM0 21v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151C7.563 6.068 6 8.789 6 11h4v10H0z" />
      </svg>
      <p className="text-[14px] text-[var(--text-secondary)] leading-relaxed mb-4">&ldquo;{quote}&rdquo;</p>
      <div>
        <span className="text-[13px] font-semibold text-[var(--text-primary)]">{name}</span>
        <span className="text-[12px] text-[var(--text-tertiary)] ml-2">{role}</span>
      </div>
    </div>
  );
}

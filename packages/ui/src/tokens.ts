// ABOUTME: Design tokens for Execution Layer v0 - spacing, typography, colors, radius
...
export const tokens = {
  ...
  // Colors - calm, professional, Linear-inspired
  colors: {
    // Neutrals (blue-gray undertone like Linear)
    gray: {
      50: '#fafafa',
      100: '#f4f4f5',
      200: '#e4e4e7',

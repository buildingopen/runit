 ...
 *
 * Drag-and-drop file upload with base64 encoding and preview
 */

'use client';

import { useState, useRef } from 'react';
import type { FileUpload, FileUploaderProps } from '../types';
...
export function FileUploader({
  ...
  return (
    <div className="openapi-form-file-uploader space-y-3">
      <div
        onClick={handleClick}
        onDrop={handleDrop}
